...
\section{Geometry}{
  ...
  \subsection{Intersecao De Circulos}{
    \begin{figure}[h!]
      \centering
      \includegraphics[scale=0.7]{"codes/geometry/Intersecao de Circulos.jpg"}
    \end{figure}
  }
...
\section{Math}{
  ...
  \subsection{Inclusao-Exclusao}{
    \begin{figure}[h!]
      \centering
      \includegraphics[scale=0.7]{"codes/math/Inclusao-Exclusao.jpg"}
    \end{figure}
  }
