...
private:
  void st_build(const int l, const int r, const int pos,
  ...
  int st_query(const int l, const int r, const int x1, const int y1,
               const int x2, const int y2, const int pos) {
    if (l > x2 || r < x1)
  ...
  void st_update(const int l, const int r, const int x, const int y,
