...
\title{Competitive Programming Library \\ \large ***DO NOT DISCLOSE OR DISTRIBUTE***}
...
\section{Funcoes Interessantes}{
  ...
  \subsection{READINT}{
    \includecode{"Funcoes Interessantes"/"readint.cpp"}
  }
...
\section{Math}{
  ...
  \subsection{COMBINAÇÃO nCr mod Primo}{
  ...
  \subsection{Compressão de Pontos} {
...
\section{Geometry}{
  ...
  \subsection{POINT INSIDE CONVEX POLYGON – $O(log n)$}{
...
\section{Data Structures}{
  \subsection{SEGMENT TREE RMQ MIN-MAX + LAZY PROPAGATION}{
    \includecode{"Data Structures"/segment_tree.cpp}
  }
  ...
  \subsection{BIT 2D}{
    \includecode{"Data Structures"/"BIT2D".cpp}
  }
  ...
  \subsection{SPARSE TABLE}{
    \includecode{"Data Structures"/"Sparse Table.cpp"}
  }
...
\section{Diverse}{
  ...
  \subsection{SLIDING WINDOW MINIMUM - $O(N)$}{
    \includecode{Diverse/"Sliding Window Minimum.cpp"}
  }
